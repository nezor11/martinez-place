...
const ReactIcon = forwardRef<SVGSVGElement, IconProps>(
  ({ name = "React", desc, width, height, ...props }, ref) => {
    const titleId = useId();
    const descId = useId();
    return (
      <svg
...
const MemoizedReactIcon = memo(ReactIcon);

export default MemoizedReactIcon;
