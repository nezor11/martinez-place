...
/** Jetpack Compose hexagon mark in the brand blue. */
const JetpackComposeIcon = forwardRef<SVGSVGElement, IconProps>(
  ({ name = "Jetpack Compose", desc, width, height, ...props }, ref) => {
    const titleId = useId();
    const descId = useId();
    return (
      <svg
...
const MemoizedJetpackComposeIcon = memo(JetpackComposeIcon);

export default MemoizedJetpackComposeIcon;
